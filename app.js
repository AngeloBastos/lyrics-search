...
const insertNextAndPrevButtons = ({ prev, next }) => {
  prevAndNextContainer.innerHTML = `
    ${prev ? `<button class="btn" onClick="getMoreSongs('${prev}')">Ateriores</button>` : ''}
...
const handleConatainerClick = event => {
...
songsContainer.addEventListener('click', handleConatainerClick)